/****************************************************************************
** Meta object code from reading C++ file 'hexview.hpp'
**
...
#error "The header file 'hexview.hpp' doesn't include <QObject>."
...
QT_INIT_METAOBJECT const QMetaObject HexView::staticMetaObject = { {
    &QTableWidget::staticMetaObject,
    qt_meta_stringdata_HexView.data,
    qt_meta_data_HexView,
    qt_static_metacall,
    nullptr,
    nullptr
} };
