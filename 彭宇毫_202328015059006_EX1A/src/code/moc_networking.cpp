...
QT_MOC_LITERAL(1, 11, 11), // "packet_recv"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 7), // "Packet*"
QT_MOC_LITERAL(4, 32, 6), // "packet"
QT_MOC_LITERAL(5, 39, 12) // "stopped_recv"

    },
    "Networking\0packet_recv\0\0Packet*\0packet\0"
    "stopped_recv"
};
...
void Networking::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->packet_recv((*reinterpret_cast< Packet*(*)>(_a[1]))); break;
        case 1: _t->stopped_recv(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Networking::*)(Packet * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Networking::packet_recv)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Networking::stopped_recv)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void Networking::packet_recv(Packet * _t1)
{
