...
void Window::init_general() {
	...
	this->setWindowTitle("Pyh_gui_sniffer");
...
void Window::about() {
	...
	QVBoxLayout *container = new QVBoxLayout;
	QLabel *header = new QLabel("Pyh_gui_sniffer Version");
	header->setFont(local_font);

	QLabel *about_label = new QLabel("This is a packet sniffing tool coded in C++\n"
