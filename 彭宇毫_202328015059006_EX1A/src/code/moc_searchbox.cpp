/****************************************************************************
** Meta object code from reading C++ file 'searchbox.hpp'
**
...
#error "The header file 'searchbox.hpp' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 10, 14), // "reload_packets"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 13), // "PacketStream*"
QT_MOC_LITERAL(4, 40, 6), // "stream"
QT_MOC_LITERAL(5, 47, 9), // "on_submit"
QT_MOC_LITERAL(6, 57, 18) // "query_highlighting"

    },
    "SearchBox\0reload_packets\0\0PacketStream*\0"
    "stream\0on_submit\0query_highlighting"
};
...
void SearchBox::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->query_highlighting(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (SearchBox::*)(PacketStream * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SearchBox::reload_packets)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void SearchBox::reload_packets(PacketStream * _t1)
{
